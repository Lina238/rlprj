...
if __name__ == "__main__":
    sumo_config_file = "../projectnet.sumocfg"  # Remplacer par le chemin de votre fichier de configuration SUMO
    model_path = "DQL_models/traffic_light_control_episode_100.h5"  # Chemin vers le modèle enregistré
    tester = TrafficLightRLTest(model_path)
    tester.test(sumo_config_file)  # Lancer le test avec la configuration SUMO
