...
if __name__ == "__main__":
    sumo_config_file = "../projectnet.sumocfg"  # Remplacer par le fichier de configuration SUMO approprié
    model_path = "DQL_models/traffic_light_control_episode_100.h5"  # Chemin vers le modèle
