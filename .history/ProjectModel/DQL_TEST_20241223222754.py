...
import pickle
rom tensorflow.keras import losses
...
class CustomLoss(losses.Loss):
    ...
    def call(self, y_true, y_pred):
        # Implement your custom loss calculation
        return tf.reduce_mean(tf.abs(y_true - y_pred))  # Example: Mean Absolute Error
class TrafficLightRLTest:
    def __init__(self, model_path):
        self.model = tf.keras.models.load_model(model_path, custom_objects={"CustomLoss": CustomLoss()})
